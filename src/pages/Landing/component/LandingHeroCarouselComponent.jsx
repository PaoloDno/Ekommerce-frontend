...
const LandingHeroCarouselComponent = ({
  items = [],
  itemsPerView = 1,
  interval = 10500,
}) => {
    ...
    <div className="relative w-full h-full overflow-hidden" ref={carouselRef}>
      ...
      >
        {items.map((item, index) => (
          <div
            key={index}
            className="flex-shrink-0 h-[30vh] bg-cover bg-center"
            style={{
      ...
      {activeItem && (
        <div
          className="absolute top-1/2 left-1/2 -translate-x-2/3 -translate-y-2/3
          w-[70%] h-[20vh] flex flex-col justify-center gap-2
          bg-skin-primary bg-opacity-35 backdrop-blur-sm z-10 overflow-hidden"
        >
          <h1 className="font-display text-styleh4 p-2 bg-skin-primary bg-opacity-70">
            {activeItem.title}
          </h1>

          <p className="font-Receipt text-stylep3 p-2 bg-skin-primary bg-opacity-65">
      ...
      <div
        className="div flex flex-col w-full h-[15vh] bg-opacity-30 items-center
         justify-end p-2 text-skin-color1"
      >
      ...
      <div className="w-full text-stylep4 h-[10vh] p-2 flex flex-row justify-center px-4">
        {!token ? (
          ...
          <span className="text-sm text-skin-color1 opacity-90">
...
export default LandingHeroCarouselComponent;
